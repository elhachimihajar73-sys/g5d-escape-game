...
<head>
    ...
    <title>Escape Game - Salle Électricité | G5D</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .register-btn { background: linear-gradient(135deg, var(--primary), var(--primary-dark)); color: var(--dark); }
        ...
        @media (max-width: 1000px) { .rooms-grid { grid-template-columns: repeat(3, 1fr); gap: 20px; } }
        @media (max-width: 650px) { .rooms-grid { grid-template-columns: repeat(2, 1fr); gap: 15px; } .glitch { font-size: 2rem; } }
...
<nav class="glass-nav">
    ...
    <div class="nav-links">
        ...
        <?php else: ?>
            ...
            <a href="register.php" class="nav-btn register-btn">Inscription</a>
        <?php endif; ?>
    </div>
</nav>
