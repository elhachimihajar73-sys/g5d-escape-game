    ...
    <style>
        * {
        ...
        body {
            ...
            background: radial-gradient(ellipse at center, #0d0d1a 0%, #05050a 100%);
            min-height: 100vh;
            color: white;
        }
        ...
        /* Grille des salles - Propre et sans chevauchement */
        .rooms-grid {
            display: grid;
        ...
        .room-card.electric:hover .room-overlay {
            opacity: 1;
        }
